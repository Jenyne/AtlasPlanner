...
public sealed class ScoreTable
{
    ...
    public static ScoreTable Default() => new()
    {
        ...
        [
            ...
            new KeywordRule("Pack Size", ["Pack Size", "increased Monster"]),
            ...
            new KeywordRule("Delve", ["Sulphite", "Azurite", "Fossil"]),
